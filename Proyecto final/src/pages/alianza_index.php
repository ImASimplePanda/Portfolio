<?php 
    ...
    if (isset($_COOKIE['colorAlianza'])){

        $color = $_COOKIE['colorAlianza'];
        $colorTexto = "black";
...
<head>
    ...
    <link rel="stylesheet" href="../css/alianza_index.css">
</head>
<body>
    ...
    <div class="logo"></div>
        <nav>
        <ul>
            <li><a href="alianza_index.php" id="tienda">Tienda</a></li>
            <li><a href="alianza_preferencias.php" id="preferencias">Preferencias</a></li>
