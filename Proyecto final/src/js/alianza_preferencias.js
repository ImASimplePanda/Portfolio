...
const draenei = document.getElementById("draenei");
const huargen = document.getElementById("huargen");
...
function actualizarTexto(idioma) {
    switch(idioma) {
        case 'sp':
            if (abandonar) abandonar.textContent = "Abandonar alianza";
            break;
        case 'en':
            if (abandonar) abandonar.textContent = "Leave alliance";
            ...
            if (humano) humano.textContent = "Human";
            if (enano) enano.textContent = "Dwarf";
            if (draenei) draenei.textContent = "Draenei";
            if (huargen) huargen.textContent = "Huargen";
            if (elfo) elfo.textContent = "Night Elf";
            if (gnomo) gnomo.textContent = "Gnome";
