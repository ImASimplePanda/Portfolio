document.addEventListener('DOMContentLoaded', () => {
    ...
    const c_onyxia = document.getElementById("del_onyxia");
    const c_sañosa = document.getElementById("del_sañosa");
    const c_invencible = document.getElementById("del_invencible");
    const c_cenizas = document.getElementById("del_cenizas");
    const c_millagazor = document.getElementById("del_millagazor");
    const c_tempestad = document.getElementById("del_tempestad");
    const c_arenisca = document.getElementById("del_dracoarenisca");
    const c_aeonaxx = document.getElementById("del_aeonaxx");
